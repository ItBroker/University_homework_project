...
void zlab02::zadanie_2_3() {
    ...
    cout << "Zmienna c1 jest typu: " << typeid(a).name()
        << " ma rozmiar: " << sizeof(a) << " bajtow" << endl
        << "Zakres tej zmiennej to: " << int_min << " -> " << int_max
        << ", to oznacza " << int_zakres << " roznych wartosci" << endl
        << "Aktualna wartosc zmiennej to: " << a << endl
        << endl;
...
void zlab02::zadanie_2_7() {
    ...
    cout << "liczba1=" << liczba1 << " liczba2=" << liczba2
